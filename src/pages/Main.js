  ...
  return (
    <div className=' '>
      <div className='flex flex-col md:justify-center   pt-4 pb-6 text-center items-center justify-center  md:text-center'>
        <h1 className='text-3xl md:text-5xl pb-3 font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-red-600'>Search Crypto</h1>
        <form>
...
{data? data.filter((item)=>item.name.toLowerCase().includes(search)).slice(0,more).map((item)=>{
